...
import org.tattour.server.domain.order.model.Order;
...
public class EntityDtoMapperImpl implements EntityDtoMapper {
    ...
    public StickerLikedInfo toStickerLikedInfo(ProductLiked productLiked) {
        ...
        Integer discountPrice = productLiked.getSticker().getDiscount() != null ?
                productLiked.getSticker().getPrice() * (100 - productLiked.getSticker().getDiscount().getDiscountRate())
                        / 100 : null;
        Integer discountRate = productLiked.getSticker().getDiscount() != null ? productLiked.getSticker().getDiscount()
                .getDiscountRate() : null;

        StickerLikedInfo stickerLikedInfo = new StickerLikedInfo(id, stickerId, name, price, discountRate,
                discountPrice, mainImageUrl);
    ...
    @Override
    public List<PointChargeRequestInfo> toGetPointChargeRequestResList(
