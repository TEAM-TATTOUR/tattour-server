...
public class BaseResponse {
    ...
    public static ResponseEntity<?> success(SuccessType successType) {
        SuccessResponse<Object> response = new SuccessResponse<>(successType.getHttpStatusCode(),
    ...
    public static <T> ResponseEntity<?> success(SuccessType successType, T data) {
        SuccessResponse<T> response = new SuccessResponse<>(successType.getHttpStatusCode(),
                successType.getMessage(), data);
        return ResponseEntity
                .status(successType.getHttpStatusCode())
                .body(response);
    }
